# T0 — toy composite AR+diffusion training, seed=52
...
|---------|--------|---------------|------------------|
| composite | 142s | 3.539 | 6.090 |
| ar_only (B1) | 140s | 3.309 | n/a |
| diff_only (B2) | 140s | n/a | 6.523 |
| B3 ar_sub | 73s | 3.098 | n/a |
| B3 diff_sub | 72s | n/a | 6.528 |
